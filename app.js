...
const defaultData = {
  ...
  sims: [
    {id:'s1',iccid:'8986032020012345678',imsi:'460088538000818',operator:'中国移动',plan:'30GB/月',balance:86.50,status:'正常',deviceSn:'869598078703629',deviceName:'EC800M-CN 通信模组',createdAt:'2026-06-03'}
  ],
  recharges: [],
  fences: [],
  customers: [],
